...
@class SharedApiConfig, SharedFeaturedImageSerializer, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinIllegalStateException, SharedKotlinNothing, SharedKotlinRuntimeException, SharedKotlinThrowable, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerializersModule, SharedLatLngStringSerializer, SharedLocation, SharedLocationCompanion, SharedLocationDetail, SharedLocationDetailCompanion, SharedSplashData, SharedSplashDataCompanion, SharedWordPressPost, SharedWordPressPostCompanion;
...
@property (class, readonly, getter=shared) SharedApiConfig *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *BASE_URL __attribute__((swift_name("BASE_URL")));
@property (readonly) int32_t POSTS_PER_PAGE __attribute__((swift_name("POSTS_PER_PAGE")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeaturedImageSerializer")))
@interface SharedFeaturedImageSerializer : SharedBase <SharedKotlinx_serialization_coreKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)featuredImageSerializer __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFeaturedImageSerializer *shared __attribute__((swift_name("shared")));
- (NSString *)deserializeDecoder:(id<SharedKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<SharedKotlinx_serialization_coreEncoder>)encoder value:(NSString *)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<SharedKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LatLngStringSerializer")))
@interface SharedLatLngStringSerializer : SharedBase <SharedKotlinx_serialization_coreKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)latLngStringSerializer __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLatLngStringSerializer *shared __attribute__((swift_name("shared")));
- (SharedDouble *)deserializeDecoder:(id<SharedKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<SharedKotlinx_serialization_coreEncoder>)encoder value:(SharedDouble *)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<SharedKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end
...
- (SharedLocation *)doCopyId:(int32_t)id name:(NSString *)name __attribute__((swift_name("doCopy(id:name:)")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocationDetail")))
@interface SharedLocationDetail : SharedBase
- (instancetype)initWithId:(int32_t)id name:(NSString *)name phone:(NSString *)phone email:(NSString *)email latitude:(double)latitude longitude:(double)longitude __attribute__((swift_name("init(id:name:phone:email:latitude:longitude:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLocationDetailCompanion *companion __attribute__((swift_name("companion")));
- (SharedLocationDetail *)doCopyId:(int32_t)id name:(NSString *)name phone:(NSString *)phone email:(NSString *)email latitude:(double)latitude longitude:(double)longitude __attribute__((swift_name("doCopy(id:name:phone:email:latitude:longitude:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.Serializable(with=NormalClass(value=com/dabbled/yycd/model/LatLngStringSerializer))
*/
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocationDetail.Companion")))
@interface SharedLocationDetailCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLocationDetailCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SplashData")))
@interface SharedSplashData : SharedBase
- (instancetype)initWithTitleUrl:(NSString *)titleUrl splashUrl:(NSString *)splashUrl splashText:(NSString *)splashText __attribute__((swift_name("init(titleUrl:splashUrl:splashText:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedSplashDataCompanion *companion __attribute__((swift_name("companion")));
- (SharedSplashData *)doCopyTitleUrl:(NSString *)titleUrl splashUrl:(NSString *)splashUrl splashText:(NSString *)splashText __attribute__((swift_name("doCopy(titleUrl:splashUrl:splashText:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="splash_text")
*/
@property (readonly) NSString *splashText __attribute__((swift_name("splashText")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="splash_url")
*/
@property (readonly) NSString *splashUrl __attribute__((swift_name("splashUrl")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="title_url")
*/
@property (readonly) NSString *titleUrl __attribute__((swift_name("titleUrl")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SplashData.Companion")))
@interface SharedSplashDataCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSplashDataCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WordPressPost")))
@interface SharedWordPressPost : SharedBase
- (instancetype)initWithId:(int32_t)id title:(NSString *)title url:(NSString *)url excerpt:(NSString *)excerpt content:(NSString *)content date:(NSString *)date featuredImage:(NSString *)featuredImage sticky:(BOOL)sticky __attribute__((swift_name("init(id:title:url:excerpt:content:date:featuredImage:sticky:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedWordPressPostCompanion *companion __attribute__((swift_name("companion")));
- (SharedWordPressPost *)doCopyId:(int32_t)id title:(NSString *)title url:(NSString *)url excerpt:(NSString *)excerpt content:(NSString *)content date:(NSString *)date featuredImage:(NSString *)featuredImage sticky:(BOOL)sticky __attribute__((swift_name("doCopy(id:title:url:excerpt:content:date:featuredImage:sticky:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="featured_image")
 *   kotlinx.serialization.Serializable(with=NormalClass(value=com/dabbled/yycd/model/FeaturedImageSerializer))
*/
@property (readonly) NSString *featuredImage __attribute__((swift_name("featuredImage")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) BOOL sticky __attribute__((swift_name("sticky")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property (readonly) NSString *url __attribute__((swift_name("url")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WordPressPost.Companion")))
@interface SharedWordPressPostCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedWordPressPostCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("YYCDRepository")))
@interface SharedYYCDRepository : SharedBase
...
*/
- (void)getLocationDetailLocationId:(int32_t)locationId completionHandler:(void (^)(SharedLocationDetail * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLocationDetail(locationId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getLocationsWithCompletionHandler:(void (^)(NSArray<SharedLocation *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLocations(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPostsForLocationLocationId:(int32_t)locationId page:(int32_t)page completionHandler:(void (^)(NSArray<SharedWordPressPost *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPostsForLocation(locationId:page:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getSplashDataWithCompletionHandler:(void (^)(SharedSplashData * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getSplashData(completionHandler:)")));
@end
